...
public class SeedingService {
    ...
    public SeedingService(AddressRepo addressRepo, UserServiceImpl userService, BookRepo bookRepo, CartRepo cartRepo, OrderRepo orderRepo, OrderDetailRepo orderDetailRepo, StoreRepo storeRepo, StockRepo stockRepo) {
    ...
    public String seeding() {
        for (User user : seeding.createUser()) {
